...
public class AppCardDeliveryTaskOneTest {
    ...
    private String generateDate (int addDays, String pattern) {
        return LocalDate.now().plusDays(addDays).format(DateTimeFornatter.ofPattern(pattern));
    }
    ...
    public void shouldBeSuccessfullyCompleted() {
        ...
        $("[data-test-id='date'] input").sendKays(Keys.chord(Keys.SHIFT, Keys.HOME), Keys.DELITE...);
